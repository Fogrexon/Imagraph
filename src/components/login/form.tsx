...
const PasswordLogin = () => (
  <div className="w-11/12 h-11/12 relative px-3 py-6 shadow rounded-md">
    ...
    <div>
      <button type="button" className="bg-blue-500 text-white mx-1 my-2 px-4 py-2 rounded-md" disabled>Login</button>
    </div>
...
const LoginCard = () => (
  <div className="flex flex-col shadow">
    ...
    <div className="flex xl:flex-row flex-col items-center justify-between">
      <div className="xl:w-2/4 w-full flex items-center justify-center px-6 py-6 relative"><PasswordLogin /></div>
